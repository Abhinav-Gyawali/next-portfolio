    ...
    >
      ...
      <div className="z-9">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Abhinav-Gyawali/">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://np.linkedin.com/in/abhinav-gyawali-4b136731a">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-blue-200 hover:bg-teal-600 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
          </form>
