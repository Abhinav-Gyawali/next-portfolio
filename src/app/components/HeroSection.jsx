      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <motion.div
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            I&apos;m Abhinav Gyawali, a 17-year-old developer with a passion for coding and technology. I specialize in React and Django, and I love building innovative web solutions. I&apos;m always eager to learn, improve my skills, and take on new challenges in the tech world.
          </p>
          <div>
            <Link
              href="/#contact"
